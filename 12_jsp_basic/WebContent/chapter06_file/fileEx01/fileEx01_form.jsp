...
<body>
	...
	<!-- 
	 ...
	 <fieldset>
	 	...
	 	<table border="1"> 
	 		<tr>
	 			<td><img src="../../img/404.PNG" width="70px" height="70px" alt="404에러 이미지"></td>
	 			<td>404에러 이미지</td>
	 			<td><a href="fileEx01_download.jsp?fileName=404.PNG">다운로드</a></td>
	 		</tr>
	 		<tr>
	 			<td><img src="../../img/500.PNG" width="70px" height="70px" alt="500에러 이미지"></td>
	 			<td>500에러 이미지</td>
	 			<td><a href="fileEx01_download.jsp?fileName=500.PNG">다운로드</a></td>
	 		</tr>
	 		<tr>
	 			<td><img src="../../img/notebook.PNG" width="70px" height="70px" alt="notebook 이미지"></td>
	 			<td>notebook 이미지</td>
	 			<td><a href="fileEx01_download.jsp?fileName=notebook.PNG">다운로드</a></td>
	 		</tr>
	 	</table>
	 </fieldset>
