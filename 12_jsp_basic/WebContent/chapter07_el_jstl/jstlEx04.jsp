...
<body>
	...
	<h3>숫자 형식</h3>
	<p>${nData }</p>
	<p><fmt:formatNumber value="${nData }"/></p>				<!-- 천 단위 자리수 , 표시 -->
	<p><fmt:formatNumber value="${nData }" pattern=".0"/></p>	<!-- 소수점 한 자리까지 표시 -->
	<p><fmt:formatNumber value="${nData }" pattern=".00"/></p>  <!-- 소수점 두 자리까지 표시 -->
	<p><fmt:formatNumber value="${nData }" pattern=".000"/></p> <!-- 소수점 세 자리까지 표시 --> 
	
	<p><fmt:formatNumber value="100" pattern="000"/> </p>		<!-- 3자리 고정후 좌측정렬 후 표시 -->
