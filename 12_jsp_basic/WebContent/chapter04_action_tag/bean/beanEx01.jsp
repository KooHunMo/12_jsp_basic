...
<body>
	...
	<form action="beanEx01Pro.jsp" method="post">
		<p>상품 코드 : <input type="text" name="pdCd"></p>
		<p>상품 이름 : <input type="text" name="pdNm"></p>
		<p>부서 코드 : <input type="text" name="deptCd"></p>
		<p>부서 이름 : <input type="text" name="deptNm"></p>
		<p>담당자 코드 : <input type="text" name="mgrCd"></p>
		<p>담당자 이름 : <input type="text" name="mgrNm"></p>
